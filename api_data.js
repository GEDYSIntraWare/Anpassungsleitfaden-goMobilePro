define({ "api": [
  ...
  },
  {
    ...
    "group": "Actions_Callback",
    "version": "3.0.0",
    "description": "<p>Reloads currently open record.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  },
  {
    ...
    "group": "Actions",
    "version": "4.2.0",
    "description": "<p>Open record in edit mode and refresh.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  {
    "type": "get",
    "url": "/EditAdditionalData",
    "title": "EditAdditionalData",
        ...
        "Parameter": [
          {
            ...
            "description": "<p>The style of the additional data.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": true,
            "field": "listStyle",
            "defaultValue": "additionalAddressList",
            "description": "<p>The style of the list to display the additional data.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": true,
            "field": "documentStyle",
            "defaultValue": "dsAdditionalAddress",
            "description": "<p>The style of the record to display the additional data.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            ...
            "field": "buttonLabel",
            "defaultValue": "ADD",
            "description": "<p>DATA] The label of the button to add additional data.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
          ...
          },
          {
            ...
            "field": "fixedLabel",
            "defaultValue": "true",
            "description": "<p>Show label fixed instead of floating. Needs to be false if the field has no label</p>"
          },
          {
            "group": "Parameter",
            "type": "Object",
    ...
    "filename": "src/app/components/edit-fields/edit-addional-data/edit-additional-data.component.ts",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "multiValue",
            "description": "<p>Allows adding multiple attachments at once if true.Default is true. Not possible for Android API &gt;= 33 as it uses a different file chooser.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "field": "enableClear",
            "defaultValue": "false",
            "description": "<p>Show button to clear the date</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "field": "useChips",
            "defaultValue": "false",
            "description": "<p>Use chips for display and input.</p>"
          },
          {
            "group": "Parameter",
            "type": "Boolean",
            "optional": false,
            "field": "allowEditOfSelectedChips",
            "defaultValue": "false",
            "description": "<p>Allow editing of chips selected from the picklist.</p>"
          },
          {
            "group": "Parameter",
            "type": "Boolean",
            "optional": false,
            "field": "hideClearAllValuesButton",
            "defaultValue": "false",
            "description": "<p>Hide the button to clear all values.</p>"
          },
          {
            "group": "Parameter",
            "type": "Boolean",
            "optional": false,
            "field": "dontAddDescriptionToValue",
            "defaultValue": "false",
            "description": "<p>Don't add the description to the value.</p>"
          }
        ]
      },
      "examples": [
  ...
  },
  {
    ...
    "version": "5.2.4",
    "group": "EditField",
    "description": "<p>Allows using a html editor to write and format a text while also inserting images (Important! As of Version 5.2.4 this component is only supported by Business-App)</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
          ...
          },
          {
            ...
            "optional": false,
            "field": "hideToolbar",
            "description": "<p>Hides Toolbar if true. Default is false</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "height",
            "description": "<p>Determines the height of the editor container in px. Default is 375</p>"
          }
        ]
      },
      "examples": [
        {
          "title": "Example for an editor with a height of 500 pixels, and a hidden toolbar",
          "content": "{\n  \"component\": \"EditHtml\",\n  \"inputs\": {\n    \"hideToolbar\": \"true\",\n    \"height\": \"500\",\n    \"rendered\": {}\n  }\n}",
          "type": "json"
        }
      ]
    },
    "filename": "src/app/components/edit-fields/edit-html/edit-html.component.ts",
    "groupTitle": "EditField"
  },
  {
    "type": "get",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "field",
            "description": "<p>Name of field in the document to get the list of values for the selection</p>"
          },
          {
            "group": "Parameter",
            "type": "Boolean",
            "optional": false,
            "field": "rememberSelection",
            "defaultValue": "true",
            "description": "<p>Remember the selection between searches in the picklist</p>"
          },
          {
            "group": "Parameter",
            "type": "Boolean",
            ...
            "field": "useChips",
            "defaultValue": "false",
            "description": "<p>Use chips to display selected values</p>"
          },
          {
            "group": "Parameter",
            "type": "Boolean",
            ...
            "field": "allowEditOfSelectedChips",
            "defaultValue": "true",
            "description": "<p>Allow editing of selected chips</p>"
          },
          {
            "group": "Parameter",
            "type": "Boolean",
            ...
            "field": "hideClearAllValuesButton",
            "defaultValue": "false",
            "description": "<p>Hide the clear all values button</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
        ...
        "Parameter": [
          {
            ...
            "field": "mode",
            "defaultValue": "auto",
            "description": "<p>Modes are 'auto', 'checkbox', 'toggle', 'select' or 'multiselect'</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
          ...
          },
          {
            ...
            "field": "rememberSelection",
            "defaultValue": "true",
            "description": "<p>Remember the selection between searches in the picklist (only for multiselect mode)</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "type": "Boolean",
            "optional": false,
            "field": "showLikeStatus",
            "defaultValue": "false",
            "description": "<p>Shows the message like in the status component</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "buttonLabel",
            "description": "<p>label of the button for adding entries</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "hideWhenEmpty",
            "description": "<p>List of fieldnames to check, if all are not in the record divider is hidden</p>"
          },
          {
            "group": "Parameter",
            "type": "String[]",
          ...
          },
          {
            ...
            "field": "expanded",
            "defaultValue": "false",
            "description": "<p>If true section will be expandend when record is opened</p>"
          },
          {
            "group": "Parameter",
            "type": "Boolean",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "type": "Boolean",
            "optional": false,
            "field": "linesUnderSubtitle",
            "defaultValue": "false",
            "description": "<p>If &quot;true&quot; lines will be displayed under subtitle</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "callColor",
            "description": "<p>Name of color for call button</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "mailColor",
            "description": "<p>Name of color for mail button</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "mapsColor",
            "description": "<p>Name of color for maps button</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "callIcon",
            "description": "<p>Name of icon for call button</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "mailIcon",
            "description": "<p>Name of icon for mail button</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "mapsIcon",
            "description": "<p>Name of icon for maps button</p>"
          },
          {
            "group": "Parameter",
            "type": "Object",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "create",
            "description": "<p>Create record link</p>"
          },
          {
            "group": "Parameter",
            "type": "String[]",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "createAction",
            "description": "<p>Name of action from create actions of this record</p>"
          },
          {
            "group": "Parameter",
            "type": "Boolean",
          ...
          },
          {
            ...
            "optional": false,
            "field": "protocol",
            "description": "<p>(mailto:|tel:|http:) mailto: opens mail app, tel: opens phone app, http: opens browser</p>"
          },
          {
            "group": "Parameter",
            "type": "Object",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "field": "useChips",
            "defaultValue": "false",
            "description": "<p>Use chips instead of list</p>"
          },
          {
            "group": "Parameter",
            "type": "Boolean",
            ...
            "field": "stackedLabel",
            "defaultValue": "false",
            "description": "<p>Change label style, moves label on top of value if true (only with useChips=true)</p>"
          },
          {
            "group": "Parameter",
            "type": "Object",
  ...
  },
  {
    ...
    "version": "5.2.5",
    "group": "ReadField",
    "description": "<p>Allows using a html editor to read a html text</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
          ...
          },
          {
            ...
            "optional": false,
            "field": "height",
            "description": "<p>Determines the height of the component container in px. Default is 375</p>"
          }
        ]
      },
      "examples": [
        {
          "title": "Example for a component with a height of 500 pixels, and a hidden toolbar",
          "content": "{\n  \"component\": \"ReadHtml\",\n  \"inputs\": {\n    \"height\": \"500\",\n    \"rendered\": {}\n  }\n}",
          "type": "json"
        }
      ]
    },
    "filename": "src/app/components/fields/read-html/read-html.component.ts",
    "groupTitle": "ReadField"
  },
  {
    "type": "get",
    "url": "/AdditionalData",
    ...
    "filename": "src/app/components/fields/additional-data/additional-data.component.ts",
    "groupTitle": "ReadField"
  },
  {
    "type": "get",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "field": "_expandable",
            "defaultValue": "true",
            "description": "<p>Determines if the widget card can be expanded and collapsed. If the widget has no title by itself _displayTitle is required.</p>"
          },
          {
            "group": "Parameter",
            "type": "Boolean",
            "optional": false,
            "field": "_expandedDefault",
            "defaultValue": "true",
            "description": "<p>Determines if the widget should be expanded by default if it has no expanded state yet.</p>"
          }
        ]
      },
      "examples": [
